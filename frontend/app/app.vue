...
<template>
  ...
  <UApp>
    ...
    <UHeader class="w-max-[1200px] mx-auto" menu="drawer">
      <template #title>
        <NuxtLink to="/">
          <img class="w-auto h-8 shrink-0" src="/images/full_logo_color.svg" alt="BioSimulatiosn Logo - Bio and Simulations are bisected by a circular icon of two arrows interwoven like a DNA molecule">
        </NuxtLink>
      </template>
